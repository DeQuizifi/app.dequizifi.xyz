...
import { type RewardsData } from '@/lib/data/mockData';
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-gray-900 text-2xl font-bold">{data.xpLevel}</p>
            </div>
            <div className="text-right">
              <p className="text-gray-600 text-sm">
                {data.xpPointsToNext} points to next level
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-900 text-xl font-bold">{data.rank}</p>
            </div>
            <div className="text-right">
              <p className="text-gray-600 text-sm">
                Next rank unlocks at XP Level {data.nextRankUnlockLevel}
              </p>
            </div>
          </div>
        </div>
